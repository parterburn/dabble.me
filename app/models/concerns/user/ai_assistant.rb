...
Choose between one to three Feelings from the list above that best represents each of the #{num_of_entries} attached journal #{'entry'.pluralize(num_of_entries)}.

Aggregated the list and output in a markdown table format with Feeling,Frequency as headers, sorted descending by frequency.
        )
      }]
    end
