...
* [PostgreSQL][4]
* [RSpec][5]
* [Twitter Bootstrap for Sass 3.2.0+2][6]
* [Autoprefixer][7]
...
* The following environment variables on your Nitrous.IO box's `.bashrc`:
  ```bash
  export DABBLE_ME_DEV_DB_DATABASE=YOUR_DEV_DB_DATABASE
  export DABBLE_ME_DEV_DB_USER=YOUR_DEV_DB_USER
  export DABBLE_ME_DEV_DB_PASSWORD=YOUR_DEV_DB_PASSWORD
  export DABBLE_ME_DEV_DB_HOST=YOUR_DEV_DB_HOST
  export DABBLE_ME_DEV_DB_PORT=YOUR_DEV_DB_PORT

  export DABBLE_ME_TEST_DB_DATABASE=YOUR_TEST_DB_DATABASE
  export DABBLE_ME_TEST_DB_USER=YOUR_TEST_DB_USER
  export DABBLE_ME_TEST_DB_PASSWORD=YOUR_TEST_DB_PASSWORD
  export DABBLE_ME_TEST_DB_HOST=YOUR_TEST_DB_HOST
  export DABBLE_ME_TEST_DB_PORT=YOUR_TEST_DB_PORT
  ```
